  ...
  module Helpers
    module ResourceIndexHelper
      ...
      def get_options(params={})
        ...
        # Parse additional options in params
        # TODO: check whether some resource or element params are lists?
        options[:resourceids] = params["resource_id"] if params.key?("resource_id")
        options[:elementid] = params["element_id"] if params.key?("element_id")
