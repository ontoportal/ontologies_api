...
class RecommenderController < ApplicationController
  namespace "/recommender" do
    ...
    def recommend(params=nil)
      ...
      if input_type.nil? then input_type = Recommender2.settings.input_type
      ...
      if output_type.nil? then output_type = Recommender2.settings.output_type
      ...
      if max_elements_set.nil? then max_elements_set = Recommender2.settings.max_elements_set
      ...
      # TODO: New instance of the recommender each time the service is invoked? It may should be better to reuse a previously initialized instance
